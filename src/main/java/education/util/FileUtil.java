...
public class FileUtil {
    private static final String DATA_Phat =
            "C://Users//Vazgen//IdeaProjects//mavenExample//src//main//java//Data";

    public static void serializeLessons(List<Lesson> lessonList) {

        try (ObjectOutputStream out =
                     new ObjectOutputStream(new FileOutputStream(DATA_Phat + "//" + "lesson.dat"))) {
